class Visitor:
    def __init__(self, name, age, contact, category):
        # Constructor to initialize Visitor objects
    ...
    def purchase_ticket(self, ticket):
        # Method to purchase a ticket and associate it with the visitor
        self.__tickets.append(ticket)  # Adding the purchased ticket to the list of tickets
        ticket.set_visitor(self)  # Associating the ticket with the visitor

    def __str__(self):
        # Method to represent Visitor object as a string
        return f"Visitor: {self.__name}, Age: {self.__age}, Contact: {self.__contact}, Category: {self.__category}"
